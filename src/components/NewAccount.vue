<template>
    <div class='login-wrap'>
        ...
        <div class='login-card'>
            ...
            <h3 >Cat Name</h3>
            <input v-on:keyup='this.enterPress' v-model='catname' type='text'>
            <button v-on:click='this.accountClick'>Create New Account</button> 
            <div class="no-acc-wrap">
                <h3 class='no-acc'>Have an account?</h3>
                <h3 v-on:click='this.loginSwitch' class='a'>Log in</h3>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        accountClick: function() {
            ...
            axios.get('http://tina.hanaroenterprise.com/api/newaccount.php',
                {
                    params: {
